                         ...
                         <div className='productos'>
                              ...
                              <div className='catalogos-1'>
                                   <div className='catalogo'>
                                        <Link exact to="/productos"><img id='imagen-producto' src="images/perforado.jpg" alt="perforado" /></Link>
                                        <div className='linea-catalogo'>
                                        </div>
                                        <h5>Perforado</h5>
                                   </div>
                                   <div className='catalogo'>
                                        <Link exact to="/productos"><img id='imagen-producto' src="images/fresado.jpg" alt="fresado" /></Link>
                                        <div className='linea-catalogo'>
                                        </div>
                                        <h5>Fresado</h5>
                                   </div>
                                   <div className='catalogo'>
                                        <Link exact to="/productos"><img id='imagen-producto' src="images/torneado.jpg" alt="Torneado" /></Link>
                                        <div className='linea-catalogo'>
                                        </div>
                                        <h5>Torneado</h5>
                                   </div>
                                   <div className='catalogo'>
                                        <a href="Productos.html"><img id='imagen-producto' src="images/Roscado.jpg" alt="roscado" /></a>
                                        <div className='linea-catalogo'>
                                        </div>
                                        <h5>Roscado</h5>
                                   </div>
                              ...
                              <div className='catalogos-2'>
                                   <div className='catalogo'>
                                        <Link exact to="/productos.html"><img id='imagen-producto' src="images/Soluble.jpg" alt="catalogoPowermill"
                                        /> </Link>
                                        <div className='linea-catalogo'>
                                        </div>
                                   ...
                                   <div className='catalogo'>
                                        <Link exact to="/productos.html"><img id='imagen-producto' src="images/instrumentos.jpg" alt="instrumentosDeMedicion"
                                        /></Link>
                                        <div className='linea-catalogo'>
                                        </div>
